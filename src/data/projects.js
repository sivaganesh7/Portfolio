export const projects = [
  {
    id: 1,
    title: "AI Cognitive Knowledge Retrieval System",
  ...
  {
    id: 3,
    title: "TechNx — Mobile Tech News App",
    category: ["Mobile"],
  ...
  {
    id: 4,
    title: "AstraSense Lite — IoT Asset Monitor",
    category: ["IoT", "AI/ML"],
  ...
  {
    id: 5,
    title: "JobilityZone — Job Portal for PWD",
    category: ["Full-Stack", "Web"],
    stack: ["React.js", "Tailwind CSS", "Firebase", "Node.js"],
    description: "An inclusive job portal designed specifically for persons with disabilities, featuring accessible UI, smart job matching, and employer connections.",
    liveUrl: "#",
    githubUrl: "https://github.com/sivaganesh7",
    accent: "#FFB800"
  },
  {
    id: 6,
    title: "GUI Bank Management System",
    category: ["Full-Stack"],
    stack: ["Python", "SQLite3", "Tkinter"],
    description: "Desktop banking application with secure authentication, account management, transaction handling, and comprehensive CRUD operations.",
    liveUrl: "#",
    githubUrl: "https://github.com/sivaganesh7",
    accent: "#FF4ECD"
  }
...
export const projectCategories = ["All", "AI/ML", "Full-Stack", "Mobile", "IoT", "Web"];
